...
#include "CtcSharedAutomatedSetupEditorSubsystem.generated.h"

USTRUCT()
struct FCtcSharedExpressApiKeyMessage
{
	GENERATED_BODY()
...
UCLASS()
class CASTTOCLOUDSHAREDEDITOR_API UCtcSharedAutomatedSetupEditorSubsystem : public UEditorSubsystem
{
	GENERATED_BODY()
