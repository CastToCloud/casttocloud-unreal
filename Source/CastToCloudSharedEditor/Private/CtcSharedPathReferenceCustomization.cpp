...
TSharedRef<IPropertyTypeCustomization> FCtcSharedPathReferenceCustomization::MakeInstance()
{
	return MakeShared<FCtcSharedPathReferenceCustomization>();
}

void FCtcSharedPathReferenceCustomization::CustomizeHeader(TSharedRef<IPropertyHandle> PropertyHandle, FDetailWidgetRow& HeaderRow, IPropertyTypeCustomizationUtils& CustomizationUtils)
{
	...
	HeaderRow
		...
		[
			...
			.BrowseDirectory(this, &FCtcSharedPathReferenceCustomization::GetBrowseDirectory)
			.BrowseTitle(INVTEXT("Select session file to import..."))
			.FilePath(this, &FCtcSharedPathReferenceCustomization::GetFilePath)
			.FileTypeFilter(FileTypeFilter)
			.OnPathPicked(this, &FCtcSharedPathReferenceCustomization::OnFilePathPicked)
		];
	// clang-format on
}

void FCtcSharedPathReferenceCustomization::CustomizeChildren(TSharedRef<IPropertyHandle> PropertyHandle, IDetailChildrenBuilder& ChildBuilder, IPropertyTypeCustomizationUtils& CustomizationUtils)
{
}

FString FCtcSharedPathReferenceCustomization::GetBrowseDirectory() const
{
...
FString FCtcSharedPathReferenceCustomization::GetFilePath() const
{
	FString FilePath;
...
void FCtcSharedPathReferenceCustomization::OnFilePathPicked(const FString& PickedPath)
{
